...
[role="lead"]
De la documentation est également disponible pour les versions antérieures à la version 5.0 du plug-in NetApp Element pour VMware vCenter Server.


NOTE: C'est ça link:index.html["lien vers la documentation"] Pour le plug-in Element vCenter 5.0, comprend également les versions 4.6, 4.7, 4.8, 4.9 et 4.10.
