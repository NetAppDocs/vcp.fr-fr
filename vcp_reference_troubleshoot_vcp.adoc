...
* <<error_vcp48_67u1,Erreurs après la mise à niveau du plug-in NetApp Element pour VMware vCenter Server 4.8 ou version ultérieure avec VMware vCenter Server 6.7U1>>
...
SIOC is not enabled
----
. Consultez  https://kb.netapp.com/on-prem/solidfire/Element_OS_Kbs/mNode_Status_Network_Down_or_Down_in_the_mNode_Settings_tab_of_Element_Plugin_for_vCenter_VCP["cet article"] pour connaître la mesure corrective spécifique à votre problème.
