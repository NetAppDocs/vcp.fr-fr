...
[role="lead"]
Vous pouvez mettre à niveau le plug-in NetApp Element pour vCenter Server en suivant les étapes décrites pour votre installation. Le plug-in NetApp Element vCenter 5.1 est disponible en dehors des versions d'Element et d'NetApp HCI dans le cadre d'un bundle de services de gestion.
